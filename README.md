...
## 📸 效果展示
![主界面截图](https://github.com/user-attachments/assets/95073ada-b492-4bad-abae-ea4bbfd6fcae)
...
- **🛡️ 断网保护**：API请求失败时自动读取本地缓存复用天气数据，同时将预警数量强制清零，防止过期预警误导用户。
...
- **接口失效**  
 2h降雨预报的 API 可能不定期更新。若脚本持续报错，请检查网络连接或联系作者更新解析逻辑。
